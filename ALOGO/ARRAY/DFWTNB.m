function [PD,PF,Precision,F1,AUC,Accuracy,G_measure,MCC,Balance, probPos] = DFWTNB(Source,Target,isDiscrete,sigma)
...
probPos = pro_pos;
try
    [ PD,PF,Precision,F1,AUC,Accuracy,G_measure,MCC,Balance ] = Performance(Target(:,end), pro_pos); % Call self-defined Performance()
catch
